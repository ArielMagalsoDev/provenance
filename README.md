...
than a successful answer is deliberate._
...
45 cases covering answerable, unanswerable, adversarial, guided-scenario, and
...
directly, bypassing Turnstile/rate-limit/HTTP).
...
Deliberately out of scope for this project: user accounts, corpus
